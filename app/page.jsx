...
export default function HomePage() {
  return (
    <main className="page-shell" id="top">
      ...
      <a
        href="https://wa.me/917984257885?text=Hi%2C%20I%20want%20to%20book%20a%20Car%20PDI%20inspection"
        target="_blank"
        rel="noopener noreferrer"
        className="whatsapp-float"
        aria-label="Book Your Car PDI Now on WhatsApp"
      >
        ...
        <span className="whatsapp-float-label">Book Your Car PDI Now</span>
      </a>
      ...
      <section className="whatsapp-banner-section">
        <div className="container">
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="whatsapp-banner shimmer-effect"
          >
            ...
            <div className="whatsapp-banner-text">
              <span className="whatsapp-banner-label">BOOK YOUR</span>
              <span className="whatsapp-banner-cta">CAR PDI TODAY</span>
            </div>
            <div className="whatsapp-banner-arrow">→</div>
          </a>
        </div>
      </section>
